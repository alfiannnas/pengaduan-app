    ...
    <div class="content">
        ...
        <form class="form-container" method="post" enctype="multipart/form-data" action="{{ route('store-profile') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama" name="nama" value="{{ $userData->name }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="telepon" name="telepon" value="{{ $userData->telephone }}" required>
            </div>

            <div class="button-group">
                <button type="submit" class="edit-btn">Simpan</button>
                <a href="{{ route('profile') }}" class="cancel-btn">Batal</a>
            </div>
        </form>
    </div>

...
<body>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="dropdown-sub">
                        <a href="{{ route('kesalahan-penulisan-data') }}">Pengaduan Administratif</a>
    ...
    <div class="form-container">
        ...
        <form action="{{ route('keterlambatan-proses.store') }}" method="POST" enctype="multipart/form-data" id="formAdministratif">
            @csrf
            ...
            <input type="text" name="judul" value="Keterlambatan Proses Administratif" readonly>

...
<body>
    ...
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" id="formAdministratif" action="{{ route('kesalahan-penulisan-data.store') }}">
            @csrf
            ...
            <input type="text" name="judul" value="Kesalahan Penulisan Data Pribadi (Nama, Alamat, dsb)" readonly>

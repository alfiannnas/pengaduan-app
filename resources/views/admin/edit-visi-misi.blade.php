    ...
    <div class="content">
        ...
        <div class="card-table">
            <form action="{{ route('admin.profil-desa.update', ['slug' => $profilDesa->slug]) }}" method="POST" enctype="multipart/form-data" class="form-upload">
                ...
                <div style="margin-bottom: 20px;">
                    <label for="visi" style="display: block; margin-bottom: 8px; font-weight: bold;">Visi</label>
                    <textarea id="visi" name="visi" rows="3" style="width:100%; padding:8px; border:1px solid #ddd; border-radius:4px;">{{ old('visi', isset($visi) ? $visi : '') }}</textarea>
                </div>
                <div style="margin-bottom: 20px;">
                    <label for="misi" style="display: block; margin-bottom: 8px; font-weight: bold;">Misi</label>
                    <textarea id="misi" name="misi" rows="5" style="width:100%; padding:8px; border:1px solid #ddd; border-radius:4px;">{{ old('misi', isset($misi) ? $misi : '') }}</textarea>
                </div>

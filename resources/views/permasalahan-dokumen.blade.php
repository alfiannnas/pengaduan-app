...
<head>
    ...
    <style>
        /* [CSS Kamu di sini - tetap sama kayak yang sudah kamu kasih] */
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <div class="dropdown">
                <a href="?page=form">PROFIL DESA</a>
                <div class="dropdown-content">
    ...
    <div class="form-container">
        ...
        <form method="POST" enctype="multipart/form-data" id="formAdministratif" action="{{ route('permasalahan-dokumen.store') }}">
            @csrf
            ...
            <input type="text" name="judul" value="Permasalahan Dokumen (KK, KTP, Surat Keterangan, dsb)" readonly>
